...
class LSTMModel(nn.Module):
    def __init__(self, num_words: int, num_dep_words: int, num_categories: int, hidden_size: int, dropout_p: float) -> None:
        ...
        self.depnet = FeatNet(num_dep_words, hidden_size, dropout_p=dropout_p)
    ...
    def forward(self, text: torch.Tensor, feats: torch.Tensor, feats_offsets: torch.Tensor) -> torch.Tensor:
        # deps is a word bag of dependency indices
