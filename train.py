...
def train_word_bag(config, model, model_name, device, n_epochs, force_cache_miss, force_download, tokenizer_path=None, checkpoint=None):
...
def train_logistic(device, n_epochs, force_cache_miss, force_download, tokenizer_path=None, checkpoint=None):
...
def train_nn(device, n_epochs, force_cache_miss, force_download, tokenizer_path=None, checkpoint=None):
...
def train_distil_bert(device, n_epochs, force_cache_miss, force_download, tokenizer_path=None, checkpoint=None):
    ...
    bert_fine_tune.train_distil_bert("distil_bert", model, config, train, val, n_epochs, device, checkpoint)
...
if __name__ == '__main__':
    ...
    trainer(args.device, args.n_epochs, args.force_cache_miss, args.force_download, args.tokenizer, args.checkpoint)
